...
namespace Lanina.Public.Web.Api.Controllers
{
    ...
    public class ApplicantController : ControllerBase
    {
        ...
        private readonly LaNinaApplicantDbContext _applicantDbContext;
        private readonly LaNinaFlagDbContext _flagDbContext;
        ...
        public ApplicantController(
            ...
            LaNinaApplicantDbContext applicantDbContext,
            IHostingEnvironment env,
            IOptions<AdminSettings> adminSettings,
            GoogleReCaptchaClient reCaptchaClient,
            LaNinaFlagDbContext flagDbContext)
        {
        ...
        public IActionResult ConfirmEmail([FromBody]ConfirmEmailInput input)
        {
            ...
            var applicant = _applicantDbContext.Applicants.FirstOrDefault(a => a.EmailConfirmationKey == input.EmailConfirmationKey);
        ...
        public IActionResult ConfirmMobilePhone([FromBody]ConfirmMobilePhoneInput input)
        {
            ...
            var applicant = _applicantDbContext.Applicants.FirstOrDefault(a => a.MobilePhoneConfirmationKey == input.MobilePhoneConfirmationKey);
        ...
        public IActionResult GetInterviewDates([FromHeader]string applicantKey)
        {
            ...
            var applicant = _applicantDbContext.Applicants.AsNoTracking().FirstOrDefault(a => a.Key == applicantKey);
            ...
            var interviewDateDTOList = _applicantDbContext.InterviewDates
                .AsNoTracking()
                .Where(id =>
                    id.InterviewId == null
        ...
        public IActionResult SetInterviewDate([FromBody]SetInterviewDateInput input)
        {
            ...
            var applicant = _applicantDbContext.Applicants
            ...
            var interviewDate = _applicantDbContext.InterviewDates.FirstOrDefault(id =>
            ...
            var reserveMeetingRoom = _applicantDbContext.Interviews.Count(i =>
            ...
            _applicantDbContext.Interviews.Add(newInterview);
            _applicantDbContext.SaveChanges();
        ...
        public IActionResult InviteApplicant([FromBody]InviteApplicantInput input, [FromHeader]string secret)
        {
            ...
            var applicant = _applicantDbContext.Applicants.FirstOrDefault(a => a.Key == input.ApplicantKey);
        ...
        public IActionResult GetInterviews([FromHeader]string secret)
        {
            ...
            var interviews = _applicantDbContext.Interviews
        ...
        public IActionResult AddInterviewDates([FromBody]AddInterviewDatesInput input, [FromHeader]string secret)
        {
            ...
            foreach (var date in input.Dates)
            {
                ...
                _applicantDbContext.InterviewDates.Add(newInterviewDate);
            }
        ...
        public IActionResult GetAllFlags([FromHeader]string flag)
        {
            ...
            result = _flagDbContext.Flags.AsNoTracking().FromSql("SELECT * FROM Flags WHERE Value = '" + flag + "'").ToList();

            var flags = _flagDbContext.Flags.ToList();
        ...
        public IActionResult GetApplyToken([FromForm(Name = "g-recaptcha-response")]string gReCaptchaResponse)
        {
            ...
            _applicantDbContext.ApplyTokens.Add(newApplyToken);
            _applicantDbContext.SaveChanges();
        ...
        public IActionResult CheckInterviews([FromQuery]string secret)
        {
            ...
            var interviewsToRemindAbout = _applicantDbContext.Interviews
                .Include(i => i.Applicant)
                .Include(i => i.InterviewDate)
                .Where(i =>
            ...
            //var interviewsToDeleteMettingRoomReservation = _applicantDbContext.Interviews
            //    .Where(i =>
